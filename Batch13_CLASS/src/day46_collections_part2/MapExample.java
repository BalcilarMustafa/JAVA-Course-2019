...
public class MapExample {
	...
	public static void main(String[] args) {
		...
		items.put("Milk", 5.0);
		items.put("Milk", 4.0);  // Milk's value reassigned(changed) no new object.  (key needs to be unique)
		...
		System.out.println(items); //no ordered
		...
		items.replace("Cherrries", 6.00, 8.00);// replace with old and new values.
	}	
}